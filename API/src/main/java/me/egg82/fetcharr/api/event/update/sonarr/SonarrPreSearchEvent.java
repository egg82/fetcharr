 ...
 */
public class SonarrPreSearchEvent extends AbstractCancellableUpdaterEvent {
    private List<SeriesResource> resources;

    public SonarrPreSearchEvent(@NotNull List<@NotNull SeriesResource> resources, @NotNull Updater updater, @NotNull FetcharrAPI api) {
        super(updater, api);
    ...
    public boolean equals(Object o) {
        if (!(o instanceof SonarrPreSearchEvent that)) return false;
