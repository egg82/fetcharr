 ...
 */
public class RadarrSelectMovieEvent extends AbstractCancellableUpdaterEvent {
    private final MovieResource resource;

    public RadarrSelectMovieEvent(@NotNull MovieResource resource, @NotNull Updater updater, @NotNull FetcharrAPI api) {
        super(updater, api);
    ...
    public boolean equals(Object o) {
        if (!(o instanceof RadarrSelectMovieEvent that)) return false;
