...
public class QualityProfileQualityItem extends AbstractAPIObject {
    ...
    public QualityProfileQualityItem(@NotNull ArrAPI api, @NotNull JSONObject obj) {
        super(api, obj);
    ...
    public boolean equals(Object o) {
        if (!(o instanceof QualityProfileQualityItem that)) return false;
        return id == that.id;
    }
    ...
    public String toString() {
        return "QualityProfileQualityItem{" +
                "id=" + id +
                ", name='" + name + '\'' +
                ", quality=" + quality +
                ", items=" + items +
