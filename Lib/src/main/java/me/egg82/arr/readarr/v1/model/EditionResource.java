...
public class EditionResource extends AbstractAPIObject {
    ...
    public EditionResource(@NotNull ArrAPI api, @NotNull JSONObject obj) {
        super(api, obj);
    ...
    public boolean equals(Object o) {
        if (!(o instanceof EditionResource that)) return false;
        return id == that.id;
    }
