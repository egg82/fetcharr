...
public class AllSeries extends AbstractAPIObject<AllSeries> {
    public static AllSeries UNKNOWN = new AllSeries(ArrAPI.UNKNOWN);
    ...
    public @NotNull Set<@NotNull Series> items() {
        return items;
    }

    @Override
    public boolean equals(Object o) {
        if (!(o instanceof AllSeries allSeries)) return false;
        return Objects.equals(items, allSeries.items);
    }
