...
public enum WhisparrConfigVars {
    ...
    SEARCH_AMOUNT(Integer.class, "WHISPARR_{}_SEARCH_AMOUNT", CommonConfigVars.getInt(CommonConfigVars.SEARCH_AMOUNT)),
    SEARCH_INTERVAL(TimeValue.class, "WHISPARR_{}_SEARCH_INTERVAL", CommonConfigVars.getTimeValue(CommonConfigVars.SEARCH_INTERVAL)),
    MONITORED_ONLY(Boolean.class, "WHISPARR_{}_MONITORED_ONLY", CommonConfigVars.getBool(CommonConfigVars.MONITORED_ONLY)),
    MISSING_ONLY(Boolean.class, "WHISPARR_{}_MISSING_ONLY", CommonConfigVars.getBool(CommonConfigVars.MISSING_ONLY)),
    SKIP_TAGS(String[].class, "WHISPARR_{}_SKIP_TAGS", CommonConfigVars.getArr(CommonConfigVars.SKIP_TAGS)),
    USE_CUTOFF(Boolean.class, "WHISPARR_{}_USE_CUTOFF", CommonConfigVars.getBool(CommonConfigVars.USE_CUTOFF));
