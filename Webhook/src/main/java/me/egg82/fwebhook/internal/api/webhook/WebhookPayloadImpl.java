...
public class WebhookPayloadImpl implements WebhookPayload {
    ...
    public WebhookPayloadImpl(@NotNull String path, @NotNull String accept, @Nullable Map<String, @NotNull String> headers, byte @NotNull [] body, @NotNull WebhookPayloadMethod method) {
        this.path = path;
        this.accept = accept;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(path, that.path) && Objects.equals(accept, that.accept) && Objects.equals(headers, that.headers) && Objects.deepEquals(body, that.body) && method == that.method;
    }

    @Override
    public int hashCode() {
        return Objects.hash(path, accept, headers, Arrays.hashCode(body), method);
    }
