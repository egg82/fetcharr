...
|------------------|-------------|---------------------------------|------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| PUID             | integer     | 0-65535                         | 1000                         | Process UID override, eg. Unraid would be 99. Only works when starting as root. See: [Running as a different user](#running-as-a-different-user)  |
| PGID             | integer     | 0-65535                         | 1000                         | Process GID override, eg. Unraid would be 100. Only works when starting as root. See: [Running as a different user](#running-as-a-different-user) |
...
| MAX_RAM          | string      | 512m, 1g, 2g, etc               | 1g                           | Upper bound for heap size, applied when run with no memory limit on the container                                                                 |
